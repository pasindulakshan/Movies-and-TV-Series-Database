...
<%@page import="com.model.Episode"%>

<%! @SuppressWarnings("unchecked") %>


<%TVShow m = (TVShow) request.getAttribute("tvshow");%>

<!-- Include Header -->
<jsp:include page="main-header.jsp">
	<jsp:param value="TVShow" name="title"/>
</jsp:include>
		...
		<div class="row ipad-width2">
			<div class="col-md-4 col-sm-12 col-xs-12">
				<div class="movie-img sticky-sb">
					<img src="image/tvshows/covers/<%out.print(m.getCover());%>" alt="">
					<div class="movie-btn">	
						            ...
						            <div class="row">
						            	<div class="col-md-8 col-sm-12 col-xs-12">
											...
											<% List<Episode>  episodes= m.getEpisodes();
												...
												<div class="cast-it">
													<div class="cast-left">
														<img class="tvsepisodecover" src="image/tvshows/covers/<%out.print(m.getCover());%>" alt="">
														<a href="#"><%out.print("S0"+e.getSnumber()+"E0"+e.getEnumber());%></a>
													</div>
													<p><%out.print(e.getEtitle());%></p>
												</div>
											<%} %>
											</div>
