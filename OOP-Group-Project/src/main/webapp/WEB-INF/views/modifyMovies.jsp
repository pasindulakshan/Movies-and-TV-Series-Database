...
<jsp:include page="/WEB-INF/views/header.jsp">
	<jsp:param value="Modify Movie" name="title"/>
</jsp:include>
<!-- Include Sidebar -->
...
<main class="main">
	<div class="container-fluid">
		<div class="row">
			...
			<!-- form -->
			<div class="col-12">
				<form action="ModifyMovie" class="form" enctype="multipart/form-data" method="post">
					<div class="row">
						<div class="col-12 col-md-5 form__cover">
							<div class="row">
								<div class="col-12 col-sm-6 col-md-12">
									<div class="form__img">
										<label for="form__img-upload">Upload new cover (270 x 400)</label>
										<input id="form__img-upload" name="form__img-upload" type="file" accept=".png, .jpg, .jpeg">
										<img id="form__img" src="image/movies/covers/<%out.print(movie.getCover()); %>" alt=" ">
									</div>
								</div>
							</div>
						</div>
						
						<input type="hidden" name="mid" value="<%out.print(request.getParameter("mid")); %>">

						<div class="col-12 col-md-7 form__content">
							<div class="row">
								<div class="col-12">
									<input type="text" name="title" class="form__input" placeholder="Title" value="<%out.print(movie.getTitle());%>" required>
								</div>

								<div class="col-12">
									<textarea id="text" name="description" class="form__textarea" placeholder="Description" required><%out.print(movie.getDescription());%></textarea>
								</div>

								<div class="col-12 col-lg-6">
									<input type="text" name="rdate" class="form__input" placeholder="Release date ex -2017-06-15" value="<%out.print(movie.getRdate());%>" required>
								</div>

								<div class="col-12 col-lg-6">
									<input type="text" name="runtime" class="form__input" placeholder="Running time" value="<%out.print(movie.getRuntime());%>" required>
								</div>

								<div class="col-12 col-lg-6">
									<select name="country" class="js-example-basic-multiple" id="country" required multiple>
										<!--<option selected disabled>Choose country</option>-->  
										<%out.println("<option selected value=\""+movie.getCountry()+"\">"+movie.getCountry()+"</option>"); %>
								...
								<div class="col-12 col-lg-6">
									<select class="js-example-basic-multiple" id="genre" multiple name="genres" required>
										<%List<Genre> genres = (List<Genre>)request.getAttribute("genres");
											for(Genre g : genres){
												boolean check = false;
												for(Genre gen : movie.getGenres1()){
									...
									<select class="js-example-basic-multiple" id="directors" multiple name="directors" required>
										<%List<Celebrity> directors = (List<Celebrity>)request.getAttribute("directors");
											for(Celebrity d : directors){
												boolean check = false;
												for(Celebrity celeb : movie.getDirectors1()){
									...
									<select class="js-example-basic-multiple" id="writers" multiple name="writers" required>
										<%List<Celebrity> writers = (List<Celebrity>)request.getAttribute("writers");
											for(Celebrity w : writers){
												boolean check = false;
												for(Celebrity celeb : movie.getWriters1()){
						...
						<div class="col-12">
								<input name="trailer" type="text" class="form__input" placeholder="Trailer Link" required value="<%out.print(movie.getTrailer());%>">
						</div>
						<div class="col-12">
								<input name="mdlink" type="text" class="form__input" placeholder="Downlload Link" required value="<%out.print(movie.getMdlink());%>">
						</div>
