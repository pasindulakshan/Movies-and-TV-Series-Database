...
<jsp:include page="/WEB-INF/views/header.jsp">
	<jsp:param value="Add Movie" name="title"/>
</jsp:include>
<!-- Include Sidebar -->
...
<main class="main">
	<div class="container-fluid">
		<div class="row">
			...
			<!-- form -->
			<div class="col-12">
				<form action="AddMovies" class="form" enctype="multipart/form-data" method="post">
					<div class="row">
						...
						<div class="col-12 col-md-7 form__content">
							<div class="row">
								...
								<div class="col-12 col-lg-6">
									<input type="text" name="rdate" class="form__input" placeholder="Release date ex -2017-06-15" required>
								</div>

								<div class="col-12 col-lg-6">
									<input type="text" name="runtime" class="form__input" placeholder="Running time" required>
								</div>
						...
						<div class="col-12">
								<input name="mdlink" type="text" class="form__input" placeholder="Downlload Link" required>
						</div>
						...
						<div class="col-12" id="addCastContainer">
							...
							<div class="row" >
								<div class="col-12 col-sm-6 col-md-4 col-xl-6">
									<select class="js-example-basic-multiple" id="actors2" name="actors" required multiple>
										<%for(Celebrity a : actors){
												out.print("<option value="+a.getCid()+">"+a.getFname()+" "+a.getLname()+"</option>");
											}
										%>
...
<script type="text/javascript">
	...
	if(request.getParameter("add") != null){
		...
		if(add.equals("true")) {
			out.print("msgboxbox.show('Movie successfully Added');");
		}
		if(add.equals("false")) {
			out.print("msgboxbox.show('Movie adding failed');");
		}
	}
	%>
</script>